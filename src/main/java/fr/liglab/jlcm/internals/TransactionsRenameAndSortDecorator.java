...
final class TransactionsRenameAndSortDecorator implements Iterator<TransactionReader> {
	...
	private static class CopyReader implements TransactionReader {
		...
		private TransactionReader refForOriginalTransIds;
		...
		void findNext(Iterator<TransactionReader> source, int[] rebasing) {
			...
			while (source.hasNext()) {
				...
				this.refForOriginalTransIds = transaction;
		...
		public TIntArrayList getTransactionOriginalId() {
			return this.refForOriginalTransIds.getTransactionOriginalId();
		}

		@Override
		public TIntArrayList getTransactionOriginalId(IntHolder h) {
			return this.refForOriginalTransIds.getTransactionOriginalId(h);
		}
